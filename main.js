...
var TaskView = class extends import_obsidian4.ItemView {
  ...
  async openTaskForm(task) {
    ...
    if ((formLeaf == null ? void 0 : formLeaf.view) instanceof TaskFormView) {
      formLeaf.view.onSave = () => this.render();
    }
  }
};
